...
@section('content')
    ...
    <div class="container">
        <h3  class="badge badge-info" style="color: red;
    font-weight: bold; font-size: 25px;font-style: italic;">The Admin Panel: </h3><br>
    </div>
        ...
        <div class="container">
            ...
            <ul class="timeline">
                <li><!---Time Line Element--->
                    ...
                    <div class="timeline-panel" style="background-color:#e9f1de;">
                        <div class="timeline-heading" >
                            <h3><div class="badge badge-danger">Published By: <i>{{$timeline->user->name}}</i></div></h3>
                        </div>
                        <div class="timeline-heading">
                        ...
                        <div class="timeline-body"><!---Time Line Body&Content--->
                            ...
                            <br>
                            <button class="btn btn-secondary"><a style="text-decoration: none; color: white;" href="admin_delete/{{$timeline->id}}">Delete</a></button>
                            <button class="btn btn-secondary"><a style="text-decoration: none; color: white;" href="admin_edit/{{$timeline->id}}">Edit</a></button>
